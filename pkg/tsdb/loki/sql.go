...
func normalizeGrafanaSQLRequest(req *backend.QueryDataRequest, dsInfo *datasourceInfo) (*backend.QueryDataRequest, map[string]struct{}, map[string]struct{}, map[string]error) {
